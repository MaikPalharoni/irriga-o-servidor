...
let dadosLavouraAtual = {
  ...
  umidade: 0,                 // Percentual 0-100, enviado pelo ESP-01
  chuva: false,
  bombaStatus: false,
...
app.post('/api/sensor-data', (req, res) => {
  ...
  // Percentual numerico (0-100) enviado pelo ESP-01. Se nao vier, mantem o ultimo valor conhecido.
  ...
  dadosLavouraAtual = {
    ...
    umidade: umidade,             // 0-100, vindo do ESP
